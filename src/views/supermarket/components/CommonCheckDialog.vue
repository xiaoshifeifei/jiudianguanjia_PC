<template>
  <div id="common_check_dialog">
    ...
    >
      <div v-if="checkStatus==0 && checkStatus2!=9" class="item-box">
      ...
      <div v-if="checkStatus==0 && checkStatus2!=9" class="btn-box">
        <el-button type="primary" @click="finish">接单</el-button>
        <el-button type="primary" @click="refund">拒绝</el-button>
        <el-button type="primary" @click="handleClose">关闭</el-button>
      </div>
      <div v-if="checkStatus==1 || checkStatus==2 && checkStatus2!=9" class="btn-box">
        <el-button v-if="checkStatus==1" type="primary" @click="finish2">完成</el-button>
        <el-button type="primary" @click="refund2">退款</el-button>
        <el-button type="primary" @click="handleClose">关闭</el-button>
      </div>
      <div v-if="checkStatus2==9" class="btn-box">
        <el-button type="primary" @click="handleClose">关闭</el-button>
      </div>
    </el-dialog>
  </div>
